...
if __name__ == "__main__":
    same_symbols_rate("Input\quicksay_20\symbol_list.pkl", "Input\communikate20\symbol_list.pkl")
    used_symbols_rate("Input\quicksay_20\symbol_list.pkl", "Input\communikate20\symbol_list.pkl","result\quick20.txt", "result\communicate20_03.txt")
